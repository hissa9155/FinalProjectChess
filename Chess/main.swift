...
//let pos1 = Position(square: "d7")
//let pos2 = Position(square: "d5")
//board.move(from: Position(square: "e2"), to: Position(square: "e4"))
//board.move(from: Position(square: "d2"), to: Position(square: "d4"))
//board.move(from: Position(square: "c8"), to: Position(square: "g4"))
//board.move(from: pos1, to: pos2)
//
//board.displayBoard()


board.move(from: Position(square: "c2"), to: Position(square: "c4"))
//board.move(from: Position(square: "e2"), to: Position(square: "e3"))
